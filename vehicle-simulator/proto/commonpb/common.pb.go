...
type Command struct {
	...
	Type          Type                   `protobuf:"varint,1,opt,name=type,proto3,enum=common.Type" json:"type,omitempty"`
...
const file_common_proto_rawDesc = "" +
	...
	"\aCommand\x12 \n" +
	"\x04type\x18\x01 \x01(\x0e2\f.common.TypeR\x04type\x12\x14\n" +
	"\x05value\x18\x02 \x01(\rR\x05value*<\n" +
	"\x04Type\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\x0f\n" +
	"\vUPDATE_RATE\x10\x01\x12\b\n" +
	"\x04PING\x10\x02\x12\f\n" +
	"\bSHUTDOWN\x10\x03B\x10Z\x0eproto/commonpbb\x06proto3"
...
var file_common_proto_depIdxs = []int32{
	0, // 0: common.Command.type:type_name -> common.Type
